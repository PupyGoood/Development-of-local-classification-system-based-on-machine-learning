...
def run(file_name, testing_percentage, n_neighbors, weights, feature_scaling, apply_pca, pca_components):
...
# Example usage:
# print(run('C:/Users/user/Documents/pythonprog/ML/MLGUI/scripts/bill_authentication.csv', 20, 5, 'uniform', 'StandardScaler', True, 2))
