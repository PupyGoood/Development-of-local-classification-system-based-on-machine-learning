...
def run(file_name, testing_percentage, kernel_name, poly_degree, tol_val, reg, feature_scaling, apply_pca,
        pca_components):
...
# Example usage:
# print(run('C:/Users/user/Documents/pythonprog/ML/MLGUI/scripts/bill_authentication.csv', 20, 'linear', 3, 0.001, 1, 'StandardScaler', True, 2))
